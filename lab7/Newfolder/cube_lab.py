...
def getFileContents(filename):
    p = os.path.join(os.getcwd(), "lab7/Newfolder/shaders", filename)
...
def init():
    ...
    image = Image.open("F:/AAU/3rd-year/3rd-year-2nd-semester/Graphics/Graphics/lab7/Newfolder/images/kelly.jpg")
